		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapbtpui5challange-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpui5challange-display": {
								"semanticObject": "sapbtpui5challange",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.ui5challange",
									"url": sap.ui.require.toUrl("sap/btp/ui5challange")
								}
							}
						}
					}
